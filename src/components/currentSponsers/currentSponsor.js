    ...
    <div className="sponsor" id="sponsor">
        ...
        <div className="cardSet">
          <div className="cardTrack">
            <div className="slidea">
              <a href="https://devfolio.co"><img src={img2} width="300" alt="" ></img></a>
            </div>

            <div className="slidea">
              <a href="https://polygon.technology/"><img src={img4} width="300" alt="" /></a>
            </div>
      ...
      <div className="gold-sponsors">
        ...
        <div className="cardSet">
          <div className="cardTrack">
            <div className="slidea">
             <a href="https://celo.org "> <img src={img1} height="100" alt="" /></a>
            </div>
